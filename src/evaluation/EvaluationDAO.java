...
public class EvaluationDAO {
	public int write(EvaluationDTO evaluationDTO) {
		System.out.println(evaluationDTO.getEvaluationContent());
		String SQL ="INSERT INTO EVALUATION VALUES(NULL,?,?,?,?,?,?,?,?,?,?,?,?,0)";
		Connection conn = null;
		PreparedStatement pstmt =null;
		ResultSet rs =null;//특정한 sql나온값뒤 처리하려고할때
		try {
			...
			pstmt.setString(12, evaluationDTO.getLectureDivide().replace("<", "&lt;").replaceAll(">","&gt;").replaceAll("\r\n", "<br>"));
